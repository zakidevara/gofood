...
Scenario: Adding a product to acart filled with products from the same merchant
Given a cart filled with 2 of Whopper Meal Medium from Burger King
And a list of products name : Whopper Meal Medium, Paket Geprek Bensu, Paket McSpicy Smokey BBQ Medium, Fish Fillet
